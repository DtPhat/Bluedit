        ...
        <div className='fixed inset:0 z-10 w-full flex h-13 p-1 px-3 space-x-3 items-center bg-white-reddit dark:bg-black-reddit dark:text-white-reddit border-b dark:border-grayblack-reddit'>
            <Link href='/'>
                <div className='flex space-x-2 min-w-[33px]'>
                    <Image className='w-[33px]' src='/reddit-icon.svg' width={33} height={33} alt='icon' />
                    <Image className='w-[62px] hidden lg:block' src={theme==='light'?'/reddit-text-light.svg':'/reddit-text-dark.svg'} width={62} height={62} alt='blueddit'/>
                </div>
            </Link>
