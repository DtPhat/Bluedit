export const DownvoteIcon = ({ active }) => {
  return (
    <svg
      className={`${active ? "text-blue-600" : "text-gray-reddit"} w-7 p-0.5 hover:bg-graywhite-reddit dark:hover:bg-grayblack-reddit cursor-pointer`}
